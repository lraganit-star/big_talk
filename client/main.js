...
function loadModal() {
    ...
    if (bigTalkContainer !== null) {
        bigTalkContainer.addEventListener("click", function () { return selectGroup("big_talk"); });
    }
    ...
    if (fallInLoveContainer !== null) {
        fallInLoveContainer.addEventListener("click", function () { return selectGroup("fall_in_love"); });
    }
    ...
    if (friendsContainer !== null) {
        friendsContainer.addEventListener("click", function () { return selectGroup("friends"); });
    }
}
...
function askQuestion(endpoint) {
    ...
    if (questionGroup == null) {
        console.log("Question group not chosen");
    }
    else {
        console.log(questionGroup.innerHTML);
    }
}
loadModal();
